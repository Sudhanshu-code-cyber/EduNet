...
<div class="max-w-6xl mx-auto p-8 bg-white rounded-2xl shadow-lg mt-10 border border-gray-200">
    ...
    @if (session('success'))
        <div id="successAlert" class="bg-green-100 text-green-800 px-4 py-3 mb-6 rounded-lg border border-green-300 shadow-sm relative">
            ...
            <button onclick="document.getElementById('successAlert').remove()" class="absolute top-2 right-2 text-green-600 hover:text-green-800 text-lg font-bold">&times;</button>
        </div>
    @endif
    ...
    @if (session('error'))
        <div id="errorAlert" class="relative bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded mb-4">
            ...
            <button onclick="document.getElementById('errorAlert').remove()" class="absolute top-2 right-2 text-red-600 hover:text-red-800 text-lg font-bold">&times;</button>
        </div>
    @endif
