...
<div class="max-w-7xl mx-auto p-6 bg-gray-50 min-h-screen">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <button class="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-6 py-2 shadow-md hover:shadow-lg text-sm flex items-center gap-2">
    ...
    <div class="overflow-x-auto bg-white shadow-xl rounded-lg border border-gray-200">
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-100 transition-all duration-300">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex gap-3 text-gray-600">
                                ...
                                <a href="{{ route('teacher.edit',$teacher->id) }}" data-modal-target="edit-teacher-modal-{{ $teacher->id }}"
                                    data-modal-toggle="edit-teacher-modal-{{ $teacher->id }}" title="Edit">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-4 text-center text-gray-500">No teachers found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
