<div id="marksWrapperInner">
    <form id="marksForm" class="space-y-6">
        ...
        <div class="flex justify-end space-x-4 pt-4">
            <button type="button" id="saveNext" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                Save & Next
            </button>
            <a href="{{ route('marks.entry.print', ['student_id' => $student->id, 'exam_id' => $exam->id]) }}" 
                target="_blank" 
                class="text-sm bg-green-600 text-white px-3 h-8 text-center rounded hover:bg-green-700">
                Print Marksheet
            </a>
        </div>
    </form>
