    ...
    <nav class="flex-1 space-y-1 text-sm">
      ...
      <div>
        ...
        <ul class="space-y-0.5">
          ...
          <li>
            <a href="{{ route('teacher.attendance') }}" class="block px-3 py-2 rounded-md hover:bg-gray-200 transition duration-200 text-gray-700 items-center gap-2">
...
<ul x-show="openExam" x-transition class="ml-6 mt-1 space-y-0.5 text-sm">
  ...
  <li x-data="{ openNotice: false }">
    ...
    <ul x-show="openNotice" x-transition class="ml-6 mt-1 space-y-0.5 text-sm">
      ...
      <li>
        <a href="{{ route('marks.list') }}" class="block px-3 py-2 rounded-md hover:bg-gray-200 transition duration-200 text-gray-700 items-center gap-2">
...
<ul x-show="openNotice" x-transition class="ml-6 mt-1 space-y-0.5 text-sm">
  ...
  <li>
    ...
    @csrf
      <button type="submit" class="block px-3 py-2 rounded-md text-sm text-red-600 hover:bg-red-50 transition duration-200 items-center gap-2 justify-center">
